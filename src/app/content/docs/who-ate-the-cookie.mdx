...
description: "A playful, interactive, voice-first detective game built with Next.js. Designed for accessibility and performance, with an engaging narrative that keeps players curious to the end."
demo: "whoatethecookie.fun"
repo: "github.com/zcdev/who-ate-the-cookie"
...
<li>**Audio playback:** Responses prepared with headers for blob consumption.</li>
