...
description: "A personality exploratory app built with Next.js, TypeScript, and Framer Motion, inviting users to discover their cosmic archetype through motion, storytelling, and thoughtful interaction."
demo: "palaxy.app"
repo: "github.com/zcdev/palaxy"
---
...
The Palaxy app was design and developed to merge art, logic, and play into a cohesive web experience that reflects the harmony between creativity and engineering. Designed for accessibility, optimized for performance, and fine-tuned for an one-of-the-kind and out-of-the-world experience.
...
Working with `Next.js`, `TypeScript`, `Framer Motion`, `Zod`, and `Supabase` strengthened my ability to manage complexity—integrating motion design, data validation, and UX flow into a cohesive experience. Through rapid prototyping and iterative refactoring, I refined component hierarchies, improved accessibility with meaningful ARIA labeling, and optimized rendering performance in the custom Wave Prism animation.
