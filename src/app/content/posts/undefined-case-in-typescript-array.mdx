...
<p>VSCode’s strict type-checking throws this error:</p>
...
<p>3. Type guard it conditionally to check if `value` is not undefined or set it to `0`.</p>
...
**Valuable lesson learned:** Guard your types, and define your code thoughtfully. <span className="emoji-small">😏</span>
