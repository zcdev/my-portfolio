---
title: "Chrome Autoplay Mystery in \"Who Ate the Cookie\""
slug: "chrome-autoplay-mystery"
date: "2025-07-22"
---
...
Although I could see the properties, I couldn’t override them directly — the audio element’s behavior still didn’t budge. <span class="emoji-small">🤔</span>
...
**Valuable lesson learned:** Only to realize — I forgot .then() after .play() <span class="emoji-small">🙃</span>, and maybe someone else will .catch() that. <span class="emoji-small">😏</span>

Thankfully, `audioRef.current` didn't let me override it initially, but just because it didn't work, that got me back on the right track.

**Valuable lesson learned (again):** Don't try to think through too many things too speedily at once. <span class="emoji-small">🤣</span> Slow down, focus, take it step by step, and only one step at a time!