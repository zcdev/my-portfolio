    ...
    <main className="grid grid-cols-1 lg:grid-cols-8 gap-x-8 gap-y-6 max-w-[1700px] min-h-screen text-gray-900 p-6 dark:bg-stone-950 dark:text-zinc-400">
      <aside className="mb-4 col-span-8 lg:col-span-2 text-left">
        ...
        <p className="text-base text-[17px] mb-4">
          I build thoughtful, human-centered interfaces that transform design concepts into accessible, production-ready experiences using React, Next.js, TypeScript, and modern UI technologies.
        </p>
        <p className="text-base text-[17px] mb-5 pb-6 border-b-1 border-zinc-200">
          Across my work, I prioritize accessibility, usability, dark mode, and responsive design to create intuitive digital experiences that are inclusive, reliable, and focused on real user needs.
        </p>
        <IconLinksSection />
      </aside>
